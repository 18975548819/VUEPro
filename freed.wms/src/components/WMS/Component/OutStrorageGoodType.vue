<template>
    <div id="DvType" class="DvType">
        <div class="lc1-details">物料出库类型占比(当天:{{this.ct}}条记录)</div>
...
<script>
import {requestOutStroageInfoDvActiveRingChart} from '../../../api/api'
import Vue from 'vue'
export default {
    data(){
        return{
    ...
    methods:{
        getDataFun(){
            ...
            self.ct = 0;
            requestOutStroageInfoDvActiveRingChart({PageIndex:1,PageSize:20}).then(function(res){
