<template>
  <div id="data-view" class="data-view">
        <!-- <dv-border-box-11 title="WMS系统数据管理平台"> -->
            <!-- <div id="dateDV">
                <div id="dleftDv">
                    <button @click="drawer = true" id=CloseBt><i class="el-icon-menu"></i></button><label style="margin-left:10px">{{nowDate}}</label>
                </div>
                <div id="drightDv">
            ...
            <div id="ButtonDv">
                <dv-border-box-4 style="width: calc(100% - 80px);;height:calc(45% - 5px);">
                    ...
                    <WarehouseTrends style="width: calc(100% - 0px);height:calc(100% - 50px);padding-top: 25px;padding-left: 15px;"/>
                </dv-border-box-4>
            </div>
        <!-- </dv-border-box-11> -->
  </div>
...
import InStrorage from '../Component/InStrorageGood'
import OutStrorage from '../Component/OutStrorageGood'
import ServerGood from '../Component/ServerInAndOutGood'
import ServerMaterial from '../Component/ServerDayMaterial'
import InStrorageGoodType from '../Component/InStrorageGoodType'
import OutStrorageGoodType from '../Component/OutStrorageGoodType'
import InfoOverview from '../Component/InfoOverview'
import InventoryStatistics from '../Component/InventoryStatistics'
import store from '../../../store/index'
import WarehouseTrends from '../Component/ServerDayInAndOutWarehouseTrends'
